var testShader = [
  ...
  // '  // 2D noise : fbm - fractal noise (4 octaves)',
  // '  mat2 m22 = mat2( 1.6,  1.2, -1.2,  1.6 );',
  // '  float f2d = 0.0;',
  // '  f2d  = 0.5000*noise2d( uv ); uv = m22*uv;',
  // '  f2d += 0.2500*noise2d( uv ); uv = m22*uv;',
  // '  f2d += 0.1250*noise2d( uv ); uv = m22*uv;',
  // '  f2d += 0.0625*noise2d( uv ); uv = m22*uv;',
