...
' * credited to iq [ https://www.shadertoy.com/view/Xds3zN ]. Camera path is',
' * based on Shane\'s "Subterranean Fly-Through" [',
' * https://www.shadertoy.com/view/XlXXWj ]. Additional specular lighting trick',
' * is based on "Wet stone" by TDM [ https://www.shadertoy.com/view/ldSSzV ].',
...
'}',
'',
'// From "Subterranean Fly-Through" by Shane',
'// https://www.shadertoy.com/view/XlXXWj',
'vec2 path(float z) {',
'  return vec2(',
'      TunnelAmpA * sin(z * TunnelFreqA), TunnelAmpB * cos(z * TunnelFreqB));',
'}',
'',
...
// '  vec3 ro = vec3(path(0.0), 0.0);',
'',
'  t += 0.5;',
'  vec3 target = vec3(path(t), t);',
// '  vec3 target = vec3(path(0.5), 0.5);',
...
export default noise_3d_fly_through;