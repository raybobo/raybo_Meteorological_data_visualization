...
'               length(',
'                   p * 1.0 -',
'                   vec3(cos(time * 3.0) * 6.0, sin(time * 2.0) * 5.0, 0.0)),',
'               length(',
'                   p * 2.0 -',
'                   vec3(0.0, sin(time) * 4.0, cos(time * 2.0) * 3.0)),',
'               4.0),',
'           length(',
'               p * 3.0 -',
'               vec3(cos(time * 2.0) * 3.0, 0.0, sin(time * 3.3) * 7.0)),',
'           4.0) +',
'      f * 2.5;',
'',
...
'  vec3 result = col.rgb +',
'      mix(vec3(0.3, 0.6, 1.0), vec3(0.05, 0.35, 1.0), p.y + 0.75) * (col.a);',
'',
